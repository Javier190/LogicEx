...
public class ValidParenthesisAlt {


    //Not my code..just to compare
    public static void main(String[] args) {
        System.out.println("Hello Valid ParenthesisAlt!");

        ValidParenthesisAlt validParenthesisAlt = new ValidParenthesisAlt();
        validParenthesisAlt.isValid("(}");
    }
